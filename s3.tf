...
resource "aws_s3_bucket" "generic" {
  ...
  #checkov:skip=CKV2_AWS_61: "Ensure that an S3 bucket has a lifecycle configuration" - Since this is a re-usable module, this needs to be able to be overridden. Should be verified at the root module level..
