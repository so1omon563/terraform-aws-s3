...
| <a name="input_public_access_block_required"></a> [public\_access\_block\_required](#input\_public\_access\_block\_required) | If set to `true`, the module will create a public access block configuration. If set to `false`, the module will not create a public access block configuration. This is useful if you want to manage the public access block configuration outside of this module. | `bool` | `true` | no |
