...
s3_id = tfstate.read['outputs']['generic-s3']['value']['generic-bucket']['name'].to_s
s3_prefix_id = tfstate.read['outputs']['generic-s3-prefix']['value']['generic-bucket']['name'].to_s
s3_override_id = tfstate.read['outputs']['generic-s3-override']['value']['generic-bucket']['name'].to_s
